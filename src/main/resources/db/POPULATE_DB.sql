...
VALUES -- id 100013
       ...
       -- id 100015
       ('Третья Компания', 100012, '0000000001', 'Зимняя ул. 89', 'HIGH', 'Третья', 'OTHER');
...
INSERT INTO employees (full_name, region_id, address)
VALUES ('Романов Роман Романович', 100000, 'Заставская ул. 6'),    -- id 100024
       ('Степанов Степан Степанович', 100000, 'Четвёртый пр. 10'), -- id 100025
       ('Романова Дарья Петровна', 100002, 'Пр. Отчаянных, 90'),   -- id 100026
       ('Дмитриев Дмитрий Дмитриевич', 100003, 'Непростая ул. 7'), -- id 100027
       ('Максимов Максим Максимович', 100007, 'Пр. Дно. 11'),      -- id 100028
       ('Зайцева Мария Иосифовна', 100007, 'Малая Опечаленная ул. 14'); -- id 100029
