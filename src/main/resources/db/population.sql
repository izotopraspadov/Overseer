...
VALUES ('Романов Роман Романович', 100000, 'user', '{noop}user', 'Заставская ул. 6'),         -- id 100024
       ('Степанов Степан Степанович', 100000, 'stepanov', '{noop}user2', 'Четвёртый пр. 10'), -- id 100025
       ('Романова Дарья Петровна', 100002, 'romanova', '{noop}user3', 'Пр. Отчаянных, 90'),   -- id 100026
       ('Дмитриев Дмитрий Дмитриевич', 100003, 'dmitriev', '{noop}user4', 'Непростая ул. 7'), -- id 100027
       ('Максимов Максим Максимович', 100007, 'admin', '{noop}admin', 'Пр. Дно. 11'),         -- id 100028
       ('Зайцева Мария Иосифовна', 100007, 'zaiceva', '{noop}admin2', 'Малая Опечаленная ул. 14'); -- id 100029

INSERT INTO employee_roles (employee_id, role)
VALUES (100024, 'ROLE_USER'),
       (100025, 'ROLE_USER'),
       (100026, 'ROLE_USER'),
       (100027, 'ROLE_USER'),
       (100028, 'ROLE_USER'),
