...
import edu.born.overseer.data.kot.ContactPersonData.COMPANY_1_CONTACT_PERSONS
import edu.born.overseer.data.kot.ContactPersonData.COMPANY_2_CONTACT_PERSONS
import edu.born.overseer.data.kot.ContactPersonData.COMPANY_3_CONTACT_PERSONS
...
object CompanyData {
    val COMPANY_1 = Company(COMPANY_1_ID, "First Company", REGION_1, "000000000000", "No st. one", LOW, "First", OUR)
    val COMPANY_2 = Company(COMPANY_2_ID, "Second Company", REGION_2, "0000000001", "Our street 2", MIDDLE, "Second", CUSTOMER)
    val COMPANY_3 = Company(COMPANY_3_ID, "Third Company", REGION_3, "0000000002", "Winter st. 89", HIGH, "Third", OTHER)
