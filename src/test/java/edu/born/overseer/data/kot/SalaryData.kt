...
val SALARY_1 = Salary(SALARY_1_ID, EMPLOYEE_1,
        of(2019, 9, 1),
        of(2019, 10, 1),
        valueOf(35000.00).setScale(2, RoundingMode.DOWN))

val SALARY_2 = Salary(SALARY_2_ID, EMPLOYEE_2,
        of(2019, 9, 1),
        of(2019, 10, 1),
        valueOf(35000.00).setScale(2, RoundingMode.DOWN))
...
val SALARY_4 = Salary(SALARY_4_ID, EMPLOYEE_2,
        of(2019, 9, 1),
        of(2019, 10, 1),
        valueOf(35000.00).setScale(2, RoundingMode.DOWN))
...
fun getPreparedSalaryCreate() = Salary(EMPLOYEE_1, now(), of(2019, 10, 1), valueOf(44000.00).setScale(2, RoundingMode.DOWN))

fun getPreparedSalaryDuplicate() = Salary(EMPLOYEE_1, of(2019, 10, 1), null, valueOf(44000.00).setScale(2, RoundingMode.DOWN))

fun getPreparedSalaryUpdate() = Salary(SALARY_1).apply { amount = valueOf(44000.00).setScale(2, RoundingMode.DOWN) }

fun getPreparedSalaryCreatedSet(employee: Employee) = setOf(Salary(employee, of(2019, 12, 1), null, valueOf(44000.00).setScale(2, RoundingMode.DOWN)))
